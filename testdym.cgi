...
querytravel = querytravel.replace("REPLACEME",name)
#print queryString
...
for row in resultrecieved:
        print("<li class='list-group-item'> <p style='margin:0 0 0px;'> <a href='%s'> %s  </a> by %s </p> <p style='font-size:smaller;margin:0 0 0px;'>Subject: %s </p></li> " % row)
print panelbottom
